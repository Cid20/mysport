...
import sds_java.mysport.payload.NotificationDTO;
import sds_java.mysport.payload.ResponseError;
import sds_java.mysport.payload.res.ResContactNotification;
import sds_java.mysport.payload.res.ResNotification;
import sds_java.mysport.repository.FileRepository;
import sds_java.mysport.repository.NotificationRepository;
...
public class NotificationService {
    ...
    public ApiResponse notification(User user) {
        ...
        String content = "( " + user.getUsername() + " ) foydalanuvchi sizdan shedu tizimga kirish uchun ruxsat so'ramozda . . .";
